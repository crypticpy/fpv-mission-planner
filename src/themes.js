...
export const THEMES = Object.freeze({
  'night-ops': {
    ...
    // Values from design-concepts/round-2/final/developer-assets/tokens.json.
    tokens: {
      page: '#071015', surface1: '#0d171d', surface2: '#111d23',
      ink: '#f4f7f8', ink2: '#a7b4bb', muted: '#7a8891',
      grid: '#1e2b32', baseline: '#26363f', border: 'rgba(229, 240, 247, 0.13)',
      accent: '#1677ff', onAccent: '#ffffff', button: '#16242c', buttonHover: '#1d2f38',
      series1: '#2e8bff', series2: '#ff784f', series3: '#46e59a', series4: '#f5af29',
      ringPlanned: '#2e8bff', ringBest: '#46e59a', windParticle: 'rgba(190, 226, 255, 0.62)',
      statusGood: '#46e59a', statusWarning: '#f5af29', statusSerious: '#ff875f', statusCritical: '#f05454',
      statusGoodWash: 'rgba(70, 229, 154, 0.12)', overlayScrim: 'rgba(4, 9, 12, 0.78)',
      mapCasing: '#050d12', markerBorder: '#ffffff', shadow: 'rgba(0, 0, 0, 0.52)',
