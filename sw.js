...
const CACHE_NAME = 'fpv-shell-v20';
...
const PRECACHE_URLS = [
  ...
  'src/presentation/map/layers/dive-layer.js',
  ...
  'src/render/packcards.js',
  'src/render/packinstances.js',
  'src/render/route.js',
  'src/render/session.js',
  'src/render/share.js',
  'src/render/spot-detail.js',
  'src/render/spots.js',
