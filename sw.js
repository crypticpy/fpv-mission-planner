...
const PRECACHE_URLS = [
  ...
  'js/weather.js',
  'js/windprofile.js',
  'js/catalog/classes.js',
  'js/catalog/drones.js',
  'js/catalog/manufacturers.js',
  'js/catalog/batteries.js',
  'js/catalog/payloads.js',
  'js/catalog/weather.js',
  'js/catalog/scenarios.js',
  'js/render/batterychecks.js',
  'js/render/calibration.js',
  'js/render/comparison.js',
  ...
  'js/render/format.js',
  'js/render/live.js',
  'js/render/packinstances.js',
  'js/render/route.js',
  'js/render/session.js',
  'js/render/share.js',
  'js/render/spots.js',
  'js/render/terrain.js',
  'js/render/thrustfield.js',
